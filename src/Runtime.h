...
private:
 ...
 public:
	...
	/**
	 * Pauses the current topmost activity, pushes the provided activity to the stack and starts it
	...
	/**
	 * Pauses the current topmost activity, pushes the provided activity to the stack and starts it. 
	 * A flag is set, that the calling activity expects a result from the started activity.
	 * @param activity   a const pointer to an Activity instance
	...
	/**
	 *  Stops the topmost Activity, removes it from the stack and resumes activity below
	 */ 
