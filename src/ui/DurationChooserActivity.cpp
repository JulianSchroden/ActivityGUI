...
DurationChooserActivity::DurationChooserActivity(String title, uint32_t duration, bool showTitleBar, int titleFontScale, bool showArrowHome)
:Activity(title, showTitleBar, titleFontScale, showArrowHome), duration(duration) {
