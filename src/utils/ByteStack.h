...
public:
     ...
     * @param other   a reference to an other ByteStack instace which should be copied
     */ 
     ...
     *  @return a pointer to the bytes. No const pointer is used because some libraries don't support them
     */ 
